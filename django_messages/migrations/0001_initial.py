    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_msg', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, related_name='next_messages', verbose_name='Parent message', blank=True, to='django_messages.Message', null=True)),
                ('recipient', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, related_name='received_messages', verbose_name='Recipient', blank=True, to=settings.AUTH_USER_MODEL, null=True)),
